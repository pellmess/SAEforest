...
#'
#' model1 <- SAEforest_meanV2(Y = income, X = X_covar, dName = "district",
...
#'
#' model2 <- SAEforest_meanV2(Y = income, X = X_covar, dName = "district",
#'                          smp_data = eusilcA_smp, pop_data = eusilcA_pop,
...
#'#Calculating point + MSE estimates and passing arguments to the forest
#'
#' model3 <- SAEforest_meanV2(Y = income, X = X_covar, dName = "district",
...
SAEforest_meanV2 <- function(Y, X, dName, smp_data, pop_data, mse = "none", aggData =FALSE,
